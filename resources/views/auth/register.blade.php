    ...
    <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center items-center">
        <div class="h-screen sm:h-fit max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-row-reverse items-center flex-1 overflow-hidden">
            <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 flex flex-col items-center @if (!$errors->any()) slide-in-left @endif">
                <a href="{{ route('home') }}" class="select-none cursor-pointer flex justify-center  h-12 items-center gap-[4px]">
            ...
            <div class="select-none h-[700px] relative flex-1 bg-indigo-100 text-center cover center hidden lg:flex @if (!$errors->any()) slide-in-right @endif">
                ...
                <div class="h-full w-full">
                    <img src="{{ asset('web_images/auth_images/Auth_Aliment.png') }}" alt="Presentation image" draggable="false" class="h-full w-full object-cover">
                </div>
            </div>
        </div>
    </div>
